...
public class LUTNewContService extends ServiceProxy
{
	// Input Parameters
	...
	private String  inContCode;
	private int  inContQty;
	private String  inNewCollctn;
	...
	*/
	protected void init() throws Exception {
		...
		service.initInParameter(5, "inContCode", CHARACTER, 2, 0);
		service.initInParameter(6, "inContQty", NUMBER, 2, 0);
		service.initInParameter(7, "inNewCollctn", CHARACTER, 1, 0);
	...
	public void execute() throws Exception {
		...
		service.setInputStr(5, inContCode);
		service.setInputInt(6, inContQty);
		service.setInputStr(7, inNewCollctn);
	...
	public void setinContCode(String val) {
		inContCode = val;
	}
	
	public void setinContQty(int val) {
		inContQty = val;
	}
	
	public void setinNewCollctn(String val) {
		inNewCollctn = val;
	}
