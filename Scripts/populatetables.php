<?php
	$con = mysql_connect("joseph.cedarville.edu","warehouse","vwburr15");
	if(!$con){
		die("No db connection. Bailing out.");
	}
	mysql_select_db("vwburr");
	...
	foreach($warehouses as $warehouse){
		...
		$query = "INSERT INTO WAREHOUSE (id) VALUES (".mysql_insert_id().");";
		echo $query;
	}
