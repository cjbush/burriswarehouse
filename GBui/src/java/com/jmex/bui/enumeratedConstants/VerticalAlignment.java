...
public enum VerticalAlignment {
    ...
    VerticalAlignment(int stylesheetId,String stylesheetAttribute) {
        this.stylesheetId = stylesheetId;
        this.stylesheetAttribute = stylesheetAttribute;
    }

    public static VerticalAlignment fromInt(int value) {
        for (VerticalAlignment alignment : values())
            if (alignment.stylesheetId == value)
                return alignment;
        throw new IllegalArgumentException("VerticalAlignment non-existent for value: " + value);
    }

    public static VerticalAlignment fromStylesheetAttributeString(String value) {
        for (VerticalAlignment alignment : values())
