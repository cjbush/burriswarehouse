//
// $Id: BContainer.java,v 1.3 2007/04/29 14:59:58 vivaldi Exp $
//
...
public class BContainer extends BComponent {
    ...
    /**
     * Returns the next component that should receive focus in this container given the current focus owner. If the
     * supplied current focus owner is null, the container should return its first focusable component. If the container
     * has no focusable components following the current focus, it should call {@link #getNextFocus()} to search further
     * up the hierarchy.
     */
    ...
    /**
     * Returns the previous component that should receive focus in this container given the current focus owner. If the
     * supplied current focus owner is null, the container should return its last focusable component. If the container
     * has no focusable components before the current focus, it should call {@link #getPreviousFocus()} to search
