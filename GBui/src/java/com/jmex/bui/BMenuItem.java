//
// $Id: BMenuItem.java,v 1.2 2007/04/27 19:46:29 vivaldi Exp $
//
...
public class BMenuItem extends BLabel {
    ...
    /**
     * Creates a menu item with the specified icon that will generate an {@link ActionEvent} with the specified action
     * when selected.
     */
    ...
    /**
     * Creates a menu item with the specified text and icon that will generate an {@link ActionEvent} with the specified
    ...
    /**
     * Called when the menu item is "clicked" which may due to the mouse being pressed and released while over the item
     * or due to keyboard manipulation while the item has focus.
     */
