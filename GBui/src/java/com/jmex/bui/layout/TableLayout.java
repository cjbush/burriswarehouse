//
// $Id: TableLayout.java,v 1.2 2007/04/27 19:46:32 vivaldi Exp $
//
 ...
 * the widest preferred width and height of any component in that column and row.
 * <p/>
...
public class TableLayout extends BLayoutManager {
    ...
    /**
     * Divides the column space among the columns in proportion to their preferred size. This only works with {@link
    ...
    /**
     * Configures the horizontal alignment (or stretching) of this table. This must be called before the container using
     * this layout is validated.
     */
    ...
    /**
     * Configures the vertical alignment of this table. This must be called before the container using this layout is
     * validated.
     */
    ...
    /**
     * Configures a column as fixed or free. If a table layout is configured with <code>STRETCH</code> horizontal
     * alignment, extra space is divided up among all of the non-fixed columns. All columns are non-fixed by default.
     */
    ...
    /**
     * Configures whether or not the table will force all rows to be a uniform size. This must be called before the
     * container using this layout is validated.
     */
    ...
    protected Metrics computeMetrics(BContainer target,
                                     boolean preferred,
                                     int whint) {
