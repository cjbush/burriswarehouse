//
// $Id: HTMLView.java,v 1.2 2007/04/27 19:46:34 vivaldi Exp $
//
 ...
 * factory system as we're not going to write our own HTML renderer to avoid dependence on Sun's JDK. If you don't want
 * to depend on that, don't use this class.
 * <p/>
 * <p>Note: width and height hints do not work. The Java HTML code doesn't seem to handle being sized to a particular
 * width or height and then determining its preferred span along the other axis. So we always get the "natural"
 * preferred size of the HTML without any forced wrapping. Of course if the component is forcibly made smaller, the HTML
...
public class HTMLView extends BComponent {
    ...
    /**
     * Configures the contents of this HTML view. This should be well-formed HTML which will be laid out according to
     * the previously configured style sheet (which must be set before the contents).
     */
