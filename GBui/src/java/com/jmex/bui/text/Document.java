//
// $Id: Document.java,v 1.2 2007/04/27 19:46:34 vivaldi Exp $
//
...
public class Document {
     ...
     *
     * @return true if the text was changed, false if it was rejected by the document validator.
     */
     ...
     *
     * @return true if the text was inserted, false if it was rejected by the document validator.
     */
     ...
     *
     * @return true if the text was removed, false if it was rejected by the document validator.
     */
     ...
     *
     * @return true if the text was replaced, false if it was rejected by the document validator.
     */
     ...
     *
     * @return true if the document should be configured with the specified new text, false if the old text should
     *         remain.
     */
