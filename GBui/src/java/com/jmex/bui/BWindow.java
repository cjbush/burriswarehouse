//
// $Id: BWindow.java,v 1.3 2007/04/27 22:33:51 vivaldi Exp $
//
...
//        _rootPanel.setLayoutManager(layout);
    ...
    /**
     * Set the parent window. If the parent window is removed from its root
     * node, this window will also be removed.
     */
    ...
    /**
     * Gets the MenuBar displayed in the window.
     *
...
//    }
    ...
    protected void setRootNode(BRootNode root) {
        if (_root != root) {
            ...
            if (_root == null) {
                ...
                wasAdded();
                // if we've already been configured with dimensions, start the
                // validation process,
    ...
    /**
     * Called when this window gets the focus after a window on the hierarchy
     * has been removed.
     */
    ...
    /**
     * Whether or not this window steals input from other windows further down
     * the hierarchy.
     */
    ...
    /**
     * Stores a reference to our focus when this window is no longer the
     * top-most window.
     */
