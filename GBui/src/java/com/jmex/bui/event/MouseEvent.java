//
// $Id: MouseEvent.java,v 1.2 2007/04/27 19:46:31 vivaldi Exp $
//
...
public class MouseEvent extends InputEvent {
    ...
    /**
     * An event generated when the mouse is dragged. Drag events are dispatched to the component in which a mouse is
     * clicked and held for all movement until all buttons are released.
     */
    ...
    /**
     * Returns the index of the button pertaining to this event ({@link #BUTTON1}, {@link #BUTTON2}, or {@link
     * #BUTTON3}) or -1 if this is not a button related event.
     */
    ...
    /**
     * For mouse wheel events this indicates the delta by which the wheel was moved. The units seem to be defined by the
     * underlying OpenGL wrapper, presently LWJGL.
     */
    public int getDelta() {
        return _delta;
    }
