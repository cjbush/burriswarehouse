//
// $Id: BEvent.java,v 1.2 2007/04/27 19:46:31 vivaldi Exp $
//
...
public class BEvent extends EventObject {
    ...
    /**
     * Returns true if this event should be propagated up the interface hierarchy (input events) or false if it should
     * be considered processed once it is dispatched on its originating component (derivative events like action or text
     * events).
     */
